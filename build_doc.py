...
INPUT_DIR = Path(r"D:\DATN\Planning\Content")
TEMPLATE_PATH = Path(r"D:\DATN\DocTemplate\HuongDanTB_HPTN_(26-2-2020).docx")
OUTPUT_PATH = Path(r"D:\DATN\DocOutput\DATN_Report_v3.docx")
IMAGES_DIR = Path(r"D:\DATN\DocOutput\Images")

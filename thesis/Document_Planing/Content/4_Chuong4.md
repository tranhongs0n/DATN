...
Hệ thống đánh giá chất lượng sinh văn bản dựa trên bốn tiêu chí cốt lõi (Es và cộng sự, 2023). Bốn tiêu chí này bao gồm độ chuẩn xác ngữ cảnh, độ phủ ngữ cảnh, độ trung thực để chống bịa đặt thông tin, và cuối cùng là độ liên quan của câu trả lời.

### 4.1.3. Kịch bản kiểm thử hiệu năng tối ưu hóa
Bên cạnh bài kiểm tra truy xuất tiêu chuẩn, hệ thống được thử nghiệm chịu tải thông qua hai bài kiểm thử chuyên biệt nhằm đánh giá các cơ chế tối ưu mới được tích hợp. Bài kiểm thử bộ nhớ đệm ngữ nghĩa tiến hành gửi 500 truy vấn lặp lại hoặc có biến thể ngữ nghĩa nhẹ để đo lường tỷ lệ trúng đệm và sự chênh lệch độ trễ. Bài kiểm thử chống quá tải thực hiện gửi dồn dập 2000 luồng truy vấn đồng thời qua cổng kết nối dịch vụ trí tuệ nhân tạo để cố tình gây tràn hạn mức, qua đó quan sát khả năng chống sập của hệ thống.
...
| Nhóm câu hỏi | Độ chuẩn xác | Độ phủ ngữ cảnh | Độ trung thực | Độ liên quan |
|--------------|--------------|-----------------|---------------|--------------|
...
Kết quả bài kiểm thử bộ nhớ đệm ngữ nghĩa mang lại sự đột phá về tốc độ:
...
*Hình 4.2: Giao diện nạp dữ liệu tri thức tự động trên bảng điều khiển quản trị*

...
| Từ viết tắt | Cụm từ đầy đủ tiếng Anh | Giải nghĩa tiếng Việt |
| :--- | :--- | :--- |
...
| **MOS** | Mean Opinion Score | Chỉ số đánh giá trải nghiệm người dùng |
| **NLP** | Natural Language Processing | Xử lý ngôn ngữ tự nhiên |
| **RAG** | Retrieval-Augmented Generation | Kỹ thuật sinh văn bản có tăng cường truy xuất |
| **RAGAS** | Retrieval Augmented Generation Assessment | Khung phần mềm đánh giá tự động hệ thống RAG |
| **RLHF** | Reinforcement Learning from Human Feedback | Học tăng cường từ phản hồi của người dùng |
| **UI** | User Interface | Giao diện người dùng |
| **UX** | User Experience | Trải nghiệm người dùng |

## 2. Giải thích thuật ngữ

| Thuật ngữ tiếng Anh | Giải nghĩa tiếng Việt | Mô tả |
| :--- | :--- | :--- |
| **Answer Relevance** | Answer Relevancy | Đánh giá mức độ câu trả lời đi thẳng vào trọng tâm và giải quyết trực tiếp truy vấn của người dùng. |
| **Chunk** | Phân đoạn / Mảnh tài liệu | Một phần nhỏ của văn bản gốc được cắt ra để tối ưu hóa việc nhúng và truy xuất trong không gian vector. |
| **Context Precision** | Context Precision | Đánh giá tỷ lệ thông tin hữu ích và có giá trị thực sự nằm trong các đoạn tài liệu được truy xuất. |
...
| **LLM-as-a-judge** | LLM làm giám khảo | Phương pháp sử dụng chính LLM để tự động chấm điểm và đánh giá chất lượng câu trả lời. |
| **Pattern Matching** | Đối sánh mẫu | Kỹ thuật nhận diện ngôn ngữ thông qua việc tìm kiếm sự trùng khớp với các khuôn mẫu định sẵn. |

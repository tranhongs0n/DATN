...
| F-03 | Đăng nhập an toàn | Quản trị viên | Đăng nhập vào Web Admin Dashboard sử dụng mã hóa tiêu chuẩn, có cơ chế phân quyền tài khoản. |
| F-04 | Nạp và quản trị tài liệu tri thức | Quản trị viên | Giao diện cho phép tải lên tệp PDF hoặc DOCX. Hệ thống tự động phân mảnh và nhúng vào Vector Database. Quản trị viên có thể xóa hoặc cập nhật phiên bản quy chế mới. |
...
Mặc dù trọng tâm của hệ thống là Vector Database dùng để lưu trữ các chiều không gian từ vựng, hệ thống vẫn cần một cơ sở dữ liệu quan hệ cục bộ để phục vụ phân hệ quản trị.
...
Quy trình tự động hóa thao tác chuyển đổi tài liệu thô thành Vector Database được thiết kế chạy xử lý nền để không chặn luồng hệ thống chính.
...
Thiết kế chỉ thị cho mô hình AI tập trung vào ba yêu cầu cốt lõi bao gồm tính chính xác, chống Hallucination và văn phong giao tiếp tự nhiên. 
...
*Hình 2.7: Giao diện quản trị tri thức trên Web Admin Dashboard*

...
Việc ứng dụng trợ lý ảo vào lĩnh vực giáo dục, cụ thể là công tác tuyển sinh, thuộc phạm trù bài toán hỏi đáp miền tri thức chuyên biệt. Khác với các hệ thống hỏi đáp đa miền có thể trả lời các câu hỏi thường thức chung chung, hệ thống miền chuyên biệt đòi hỏi sự am hiểu sâu sắc về một ranh giới dữ liệu cụ thể. Thách thức lớn nhất của bài toán này nằm ở yêu cầu cực kỳ khắt khe về độ chính xác. Bất kỳ sai sót nào trong việc tư vấn mã ngành, tổ hợp xét tuyển, hay điểm chuẩn đều có thể ảnh hưởng trực tiếp đến tương lai học tập của thí sinh. Do đó, hệ thống không chỉ cần khả năng hiểu câu hỏi đa dạng của học sinh mà còn phải sở hữu cơ chế đối chiếu tri thức nghiêm ngặt, đảm bảo mọi phản hồi đều dựa trên nguồn gốc thông tin chính thống từ nhà trường.
...
graph TD
    ...
    C(fa:fa-user Học sinh) -->|Đặt câu hỏi| D[Truy xuất tương đồng]
    B --> D
    D -->|Các mảnh tài liệu liên quan| E[Bộ chỉ thị định hướng]
    C -->|Câu hỏi gốc| E
    E -->|Ngữ cảnh + Câu hỏi| F[Mô hình LLM]
    F -->|Tổng hợp câu trả lời tự nhiên| G[Phản hồi cho học sinh]
    G --> End((Kết thúc))
```
